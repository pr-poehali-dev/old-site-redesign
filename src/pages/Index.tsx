...
const services: Service[] = [
  ...
  { id: 12, name: 'Ремонт корзины фрикционов муфты Hyundai/Kia 47800-3B520', category: 'Раздатка', price: 4990, duration: '1-2 дня', popular: true, description: 'Ремонтируем корзину фрикционов муфты полного привода роботизированной лазерной сваркой. Высокая точность и прочность шва. Деталь № 47800-3B520. Новая стоит в 3 раза дороже', image: 'https://cdn.poehali.dev/files/b3c88cc7-9023-4aeb-b40d-6c50c585b3bd.jpg' },
