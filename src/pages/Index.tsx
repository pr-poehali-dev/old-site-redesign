          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: 'Нужно ли снимать детали с автомобиля самостоятельно?', a: 'Мы работаем только с уже снятыми деталями — занимаемся восстановлением, а не демонтажем. Вы можете снять детали самостоятельно или обратиться в любой автосервис. После этого привезите их к нам или отправьте транспортной компанией.' },
