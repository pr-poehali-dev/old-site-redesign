...
const services: Service[] = [
  ...
  { id: 9, name: 'Раздатка Tiguan под оригинальный размер на обмен с АКПП', category: 'Раздатка', price: 35000, duration: 'В наличии', popular: true, description: 'Готовая раздатка для Tiguan с автоматом — сразу на обмен. Встанет в ваш корпус дифференциала. Гарантия 1,5 года', image: 'https://cdn.poehali.dev/files/91489e6b-a3d8-4934-8dec-a8899a6b6b63.jpg' },
  { id: 10, name: 'Раздатка в сборе + корпус дифференциала на обмен Tiguan', category: 'Раздатка', price: 55000, duration: 'В наличии', popular: true, description: 'Полный узел для Tiguan — раздатка и корпус дифференциала. Готово к установке. Обмениваете свой старый на восстановленный. Гарантия 1,5 года', image: 'https://cdn.poehali.dev/files/e1628af3-3240-49d2-8798-0ed56ac92218.jpg' },
];
