      ...
      <section id="hero" className="relative py-32 md:py-48 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-primary animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
              Восстановление шлицевых соединений
            </h1>
            <p className="text-xl text-primary/90 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
