...
Восстановление до заводских размеров. Установка без переделок`, image: 'https://cdn.poehali.dev/files/d850d4f8-78b4-4b63-b223-ab3fcd4b27a2.jpg' },
  { id: 7, name: 'Дифференциал Tiguan под оригинальный вал раздатки', category: 'Раздатка', price: 9990, duration: '1-3 дня', popular: true, description: 'Восстанавливаем дифференциал для Volkswagen Tiguan. Подойдёт к вашему родному валу раздатки без замены других деталей', image: 'https://cdn.poehali.dev/files/b3566624-d327-4f7d-9698-b55c4cc7560f.jpg' },
  { id: 8, name: 'Восстановление шлицевого соединения вала раздатки + дифференциал VW Tiguan', category: 'Раздатка', price: 34990, duration: '1-3 дня', popular: true, description: 'Комплект из двух деталей — вал раздатки и чашка дифференциала для Tiguan. Восстанавливаем обе детали в заводские размеры', image: 'https://cdn.poehali.dev/projects/8ee1c24b-26fc-4abd-acc6-886bdb63cd67/bucket/7442b765-8912-4b2b-8304-fe16f4539e78.jpg' },
  { id: 11, name: 'Восстановление шлицевого соединения вала раздатки + дифференциал Mazda CX-7', category: 'Раздатка', price: 34990, duration: '1-3 дня', popular: true, description: 'Восстанавливаем обе детали — вал и дифференциал для Mazda CX-7. Возвращаем заводские размеры. Подходит для Mazda CX-7 (2006-2012) и Mazda CX-9 (2007-2015). Термообработка для увеличения прочности. Срок службы как у новой детали', image: 'https://cdn.poehali.dev/files/58a834b2-a324-4430-878a-40a9de358bd1.jpg' },
  ...
  { id: 9, name: 'Раздатка Tiguan с АКПП на обмен', category: 'Раздатка', price: 34990, duration: 'В наличии', popular: true, description: 'Готовая раздатка для Tiguan с автоматом — сразу на обмен. Встанет в ваш корпус дифференциала. Гарантия 12 месяцев без ограничения пробега', image: 'https://cdn.poehali.dev/projects/8ee1c24b-26fc-4abd-acc6-886bdb63cd67/bucket/6b44374c-2fa2-4df9-b736-67e3cc431ab7.jpg' },
  { id: 10, name: 'Раздатка + корпус дифференциала в сборе Tiguan с АКПП на обмен', category: 'Раздатка', price: 64990, duration: 'В наличии', popular: true, description: 'Полный узел для Tiguan — раздатка и корпус дифференциала. Готово к установке. Обмениваете свой старый на восстановленный. Гарантия 12 месяцев без ограничения пробега', image: 'https://cdn.poehali.dev/projects/8ee1c24b-26fc-4abd-acc6-886bdb63cd67/bucket/4c128725-c20c-4368-97ea-2791223f7084.png' },
];
