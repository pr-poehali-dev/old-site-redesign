...
const services: Service[] = [
  ...
  { id: 4, name: 'Вал раздатки Tiguan под оригинальный корпус дифференциала', category: 'Раздатка', price: 18000, duration: '1-3 дня', popular: true, description: 'Восстановление вала раздаточной коробки Volkswagen Tiguan под оригинальный корпус дифференциала. Точное соответствие стандартам', image: 'https://cdn.poehali.dev/files/d850d4f8-78b4-4b63-b223-ab3fcd4b27a2.jpg' },
