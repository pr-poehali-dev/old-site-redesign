      ...
      <section id="faq" className="py-8 border-t">
        <div className="container">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { q: 'Как понять, что шлицы изношены?', a: 'Вибрация при разгоне, стук при трогании, рывки при переключении передач, гул со стороны раздатки.', icon: 'AlertCircle' },
                { q: 'Сколько времени занимает восстановление?', a: 'От 1 до 5 рабочих дней. Обычно справляемся за 2 дня.', icon: 'Clock' },
                { q: 'Можно ли восстановить сильно изношенные шлицы?', a: 'Наша технология восстанавливает даже критически изношенные шлицы.', icon: 'CheckCircle' },
                { q: 'Какая гарантия на восстановленные детали?', a: '18 месяцев без ограничения пробега с официальным талоном.', icon: 'Shield' },
                { q: 'Нужно ли снимать детали самостоятельно?', a: 'Работаем с уже снятыми деталями. Привезите к нам или отправьте через СДЭК.', icon: 'Package' },
