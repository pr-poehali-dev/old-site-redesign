  ...
  return (
    <div className="border-t border-dashed border-primary/20 pt-3 md:pt-4 mt-3 md:mt-4">
      ...
      <div className="grid md:grid-cols-3 gap-3 md:gap-4 items-center">
        <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-lg p-3 md:p-5 border-2 border-primary/30 hover:border-primary/50 transition-all text-center relative shadow-lg">
          ...
          <div className="flex items-center justify-center gap-1 text-[10px] md:text-xs text-muted-foreground mt-2 md:mt-3 pt-2 md:pt-3 border-t border-primary/20">
            <Icon name="Users" className="h-3 w-3" />
            <span className="font-semibold">Более 350 клиентов</span>
          </div>
        </div>
