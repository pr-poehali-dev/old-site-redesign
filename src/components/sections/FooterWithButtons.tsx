  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mb-3 md:mb-4">
            ...
            <div className="space-y-1.5 md:space-y-2">
              ...
              <a href="https://web.telegram.org/a/#777000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[10px] md:text-xs hover:text-primary transition-colors">
                <img src="https://cdn.poehali.dev/files/85c43a5d-8a97-431b-a973-3b648bc96312.png" alt="Telegram" className="h-3.5 w-3.5 flex-shrink-0" />
                Telegram
              </a>
            </div>
          </div>
      ...
      <div className="fixed bottom-3 right-3 md:bottom-6 md:right-6 z-50 flex flex-col gap-2">
        ...
        >
          <img src="https://cdn.poehali.dev/files/85c43a5d-8a97-431b-a973-3b648bc96312.png" alt="Telegram" className="h-4 w-4 md:h-6 md:w-6" />
          <span className="hidden md:block absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-green-600 text-white px-3 py-2 rounded-md text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            Написать в Telegram
          </span>
        </a>
